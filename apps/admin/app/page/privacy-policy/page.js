...
export default function PrivacyPolicy() {
  return (
    <>
      ...
      <p className="my-1 ml-1">
        At <strong>Anix7</strong> (accessible via{" "}
        <Link href="/">www.anix7.in</Link> and all associated subdomains), your
        privacy is a top priority. This Privacy Policy outlines how we collect,
        use, and protect your personal information when you use any of our
        services.
      </p>
      <p className="my-1 ml-1">
        By accessing or using Anix7 or any of its associated platforms
        (including but not limited to <strong>Anix7 Tools</strong>,{" "}
      ...
      <h3>
        ...
        <em>(only when voluntarily submitted)</em>:
      </h3>
      <ul className="list-disc ml-5 pl-5 space-y-2">
        <li>
          Name, email, or contact info (e.g., via support forms, feedback).
        </li>
        <li>
          Payment-related details if you purchase a subscription or premium
          feature.
        </li>
      </ul>
      <h3>
        b. <strong>Non-Personal Information</strong>{" "}
        <em>(automatically collected)</em>:
      </h3>
      <ul className="list-disc ml-5 pl-5 space-y-2">
        <li>Browser type, device type, OS version.</li>
        <li>IP address and approximate location.</li>
        <li>
          Pages visited, time spent, and interaction data (for analytics).
        </li>
      </ul>
      <h3>
      ...
      <ul className="list-disc ml-5 pl-5 space-y-2">
        <li>
          Images, URLs, QR data, and other content processed by our tools remain
          in your browser unless explicitly uploaded to our server (e.g., for
      ...
      <ul className="list-disc ml-5 pl-5 space-y-2">
        <li>
          To remember user preferences, improve performance, and measure usage
          patterns.
        </li>
        <li>
          We may use cookies for analytics (Google Analytics, for example), but
          we <strong>do not use cookies to sell or trade data</strong>.
        </li>
      </ul>
      <Hr />
      <h2>
      ...
      <ul className="list-disc ml-5 pl-5 space-y-2">
        ...
        <li>
          To process payments and manage subscriptions (only applicable for Pro
          features).
        </li>
      ...
      <ul className="list-disc ml-5 pl-5 space-y-2">
        <li>
          Files processed in-browser are never stored on our servers, except
          when required for specific download or sharing functions. However,
          images uploaded using the Image Upload feature are stored on our
          servers and may be publicly accessible. Users retain control and can
          delete their uploaded images at any time.
        </li>
        <li>
          Contact or support-related data may be retained as long as needed for
      ...
      <p className="my-1 ml-1">
        Anix7 is not intended for children under the age of 13. We do not
        knowingly collect personal data from children. If we learn we’ve
      ...
      <p className="my-1 ml-1">
        We may link or integrate with third-party tools and platforms (e.g.,
        Telegram bots, Imgur, Google APIs). These services operate independently
        and are governed by their own privacy policies. We recommend reviewing
        them before use.
      </p>
      <Hr />
      <h2>
      ...
      <p className="my-1 ml-1">
        We use modern security standards and best practices to protect your
        data. However, no online service is 100% secure, and we cannot guarantee
      ...
      <p className="my-1 ml-1">
        ...
        version will always be available on this page with the updated effective
        date. Continued use of Anix7 after changes indicates your acceptance of
        the updated policy.
      </p>
      <Hr />
      <h2>
